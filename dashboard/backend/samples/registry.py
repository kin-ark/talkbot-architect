...
SAMPLES = [
    ...
    {"id": "debt_collector", "title": "Debt Collection — DPD 1-5",
     "description": "Canonical mid-funnel collector: greet+confirm, inform overdue, 2-tier convincer, collect PTP, ~16 corpus intents + multi-round business KBs + disposition tags.",
